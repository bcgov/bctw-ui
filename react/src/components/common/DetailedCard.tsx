...
const DetailedStatusCard = <T extends Record<string, any>,>({displayObject, displayKeysInGrid, displayKeysInBox, headerOverride}: DetailedStatusCardProps<T>): JSX.Element => {
