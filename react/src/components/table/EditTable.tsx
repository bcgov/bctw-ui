...
type EditTableProps<T> = Omit<PlainTableProps<T>, 'headers'> &
  EditTableVisibilityProps & {
    canSave: boolean;
          ...
          <TableBody>
            {data.map((u, idx) => {
              ...
              const ComponentsFromProps = columns.map((cb, idx) => (
                <TableCell align='left' key={`custom-${idx}`}>
                  {cb(u)}
                </TableCell>
              ));
              ...
              return hideAll ? (
                ...
                <TableRow
                  ...
                  onClick={
                    isMultiSelect
                      ? (event) => handleCheckClick(event, idx)
                      : () => {
                          /*Empty function call */
                        }
                  }>
                  <TableCell align='left' /*padding="checkbox"*/>
                    {isMultiSelect && <Checkbox checked={isItemSelected} />}
                  </TableCell>
                  {ComponentsFromProps}
