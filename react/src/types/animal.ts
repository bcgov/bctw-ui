...
export class Animal implements BCTWBase<Animal>, IAnimal {
  ...
  get displayProps(): (keyof Animal)[] {
    return ['taxon', 'collection_units', 'wlh_id', 'animal_id', 'critter_status'];
...
export const critterFormFields: Record<string, FormFieldObject<Partial<Animal>>[]> = {
  ...
  identifierFields1: [
    ...
    { prop: 'collection_units', type: eInputType.code, taxon: [] } //Population unit needs to be taxon dependant, surface with code table
  ],
  identifierFields2: [
