...
export const critterHistoryProps = ['nickname', 'animal_id', 'wlh_id', 'animal_status', 'juvenile_at_heel', 'region', 'population_unit', 'valid_from', 'valid_to'];
